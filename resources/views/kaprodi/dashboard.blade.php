    ...
    <div class="col-md-4">
        <div class="card glass-card border-0 p-4 h-100 position-relative overflow-hidden" style="transition: all 0.2s;">
            ...
            <div>
                ...
                <h2 class="fw-bolder text-dark mb-0 display-5">0<span class="fs-6 fw-bold text-muted text-uppercase">Mahasiswa</span></h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card glass-card border-0 p-4 h-100 position-relative overflow-hidden" style="transition: all 0.2s;">
            ...
            <div>
                ...
                <h2 class="fw-bolder text-dark mb-0 display-5">0 <span class="fs-6 fw-bold text-muted text-uppercase">Dokumen</span></h2>
            </div>
            @if()
                <div class="mt-4 pt-3 border-top">
                    <class="btn btn-warning w-100 fw-bold rounded-pill text-dark shadow-sm">Review Sekarang <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card border-0 p-4 h-100 text-white position-relative overflow-hidden" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); border-radius: 16px; box-shadow: 0 10px 20px rgba(16, 185, 129, 0.2);">
            ...
            <div class="position-relative z-1">
                ...
                <h2 class="fw-bolder text-white mb-0 display-5">0<span class="fs-6 fw-bold opacity-75 text-uppercase">Dokumen</span></h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <table class="table table-hover align-middle border-0">
                        ...
                        <tbody class="border-top-0">
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                    <span class="badge bg-light text-dark border px-3 py-2 rounded-pill">Jurusan</span>
                                </td>
                                <td class="pe-3 py-3">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button type="button" class="btn btn-sm btn-outline-primary rounded-pill px-3 fw-medium" data-bs-toggle="modal" data-bs-target="#">
                                            <i class="bi bi-eye me-1"></i> Review
                                        </button>
                                        <form action="{{}}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menyetujui dan mempublikasikan dokumen ini ke repositori?')">
                                            @csrf
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
                                        <div class="modal-header border-0 bg-light p-4">
                                            <h5 class="modal-title fw-bold text-dark"><i class="bi bi-file-text text-primary me-2"></i> Review Dokumen Tugas Akhir</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body p-4 p-md-5">
                                            <div class="row mb-4">
                                                <div class="col-md-3 text-muted fw-semibold small text-uppercase">Judul</div>
                                                <div class="col-md-9 fw-bolder fs-5 text-dark">{{}}</div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-md-3 text-muted fw-semibold small text-uppercase">Penulis</div>
                                                <div class="col-md-9 fw-medium"><img src="https://ui-avatars.com/api/?name&background=e5e7eb&color=374151&rounded=true" width="24" height="24" class="rounded-circle me-2"> {{  }}</div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-md-3 text-muted fw-semibold small text-uppercase">Program Studi</div>
                                                <div class="col-md-9 fw-medium">{{}}</div>
                                            </div>
                                            ...
                                            <div class="p-4 bg-light rounded-4 mt-5">
                                                ...
                                                <div class="d-flex flex-wrap gap-3">
                                                    <class="btn btn-outline-danger bg-white rounded-pill px-4"><i class="bi bi-file-pdf me-1"></i> Cover</a>
                                                    <class="btn btn-outline-danger bg-white rounded-pill px-4"><i class="bi bi-file-pdf me-1"></i> Abstrak</a>
                                                    <class="btn btn-outline-danger bg-white rounded-pill px-4"><i class="bi bi-eye-fill me-1"></i> Lihat Full {{  }}</a>
                                                    <class="btn btn-outline-danger bg-white rounded-pill px-4"><i class="bi bi-file-pdf me-1"></i> Daftar Pustaka</a>
                                                    @if()
                                                        <class="btn btn-outline-info bg-white text-dark rounded-pill px-4"><i class="bi bi-journal me-1"></i> Jurnal</a>
                                                    @endif
                                                    @if()
                                                        <class="btn btn-outline-info bg-white text-dark rounded-pill px-4"><i class="bi bi-shield-check me-1"></i> Turnitin</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
