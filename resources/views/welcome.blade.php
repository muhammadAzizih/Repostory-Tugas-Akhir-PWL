...
<footer class="site-footer">
    <div class="footer-inner">
        <div class="footer-brand">
            ...
            <p class="footer-desc">E-Repository Digital Tugas Akhir Mahasiswa — platform terpusat untuk akses karya ilmiah mahasiswa.</p>
        </div>
        <div class="footer-divider"></div>
        <div class="footer-team">
            <div class="footer-team-label">
                <i class="bi bi-people-fill"></i>
                Kelompok 2 — Pemrograman Web Lanjutan
            </div>
            {{-- <div class="footer-members">
                <span class="member-chip"><i class="bi bi-person-fill"></i> Nama Anggota 1</span>
                <span class="member-chip"><i class="bi bi-person-fill"></i> Nama Anggota 2</span>
                <span class="member-chip"><i class="bi bi-person-fill"></i> Nama Anggota 3</span>
                <span class="member-chip"><i class="bi bi-person-fill"></i> Nama Anggota 4</span>
                <span class="member-chip"><i class="bi bi-person-fill"></i> Nama Anggota 5</span>
                <span class="member-chip"><i class="bi bi-person-fill"></i> Nama Anggota 6</span>
            </div> --}}
        </div>
        <div class="footer-copy">
            © {{ date('Y') }} Kelar.in · Kelompok 2 PWL
        </div>
    </div>
</footer>
...
.footer-desc {
    font-size: .83rem; color: #6b7280; line-height: 1.6; margin: 0; max-width: 400px;
}
.footer-divider {
...
.footer-team-label i { color: var(--em-400); }
.footer-members {
...
.member-chip {
    ...
    border-radius: 100px;
    padding: 6px 14px;
    font-size: .78rem; font-weight: 600; color: #d1d5db;
    display: flex; align-items: center; gap: 6px;
    transition: border-color .15s, color .15s;
}
.member-chip i { color: var(--em-400); font-size: .7rem; }
.member-chip:hover { border-color: var(--em-500); color: white; }
.footer-copy {
    font-size: .73rem; color: #4b5563; font-weight: 500;
}
@media (max-width: 576px) {
    .member-chip { font-size: .72rem; padding: 5px 11px; }
}
</style>
