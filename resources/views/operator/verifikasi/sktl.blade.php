        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" target="_blank" class="btn btn-sm btn-outline-danger rounded-pill px-3">
                            <i class="bi bi-file-pdf me-1"></i> Lihat PDF
                        </a>
                    </td>
                    <td>
                        <span class="small text-muted">01 Jan 2024, 00:00</span>
                    </td>
                    <td>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <form action="#" method="POST">
                <div class="modal-body p-4">
                    <p class="small text-muted mb-4">Mahasiswa: <strong>Nama Mahasiswa</strong></p>
