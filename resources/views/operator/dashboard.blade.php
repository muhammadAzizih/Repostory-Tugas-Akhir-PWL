    ...
    <div class="col-12">
        <div class="card glass-card border-0 text-white p-4 p-md-5 position-relative overflow-hidden" style="background: linear-gradient(135deg, var(--primary) 0%, var(--primary-dark) 100%);">
            ...
            <div class="position-relative z-1">
                ...
                <h3 class="fw-bolder mb-2 display-6">Halo, {{ auth()->user()->name }}</h3>
...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 text-center" style="transition: all 0.2s;">
            ...
            <h2 class="fw-bolder text-dark mb-1 display-5">{{ $sktlPending }}</h2>
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 text-center" style="transition: all 0.2s;">
            ...
            <h2 class="fw-bolder text-dark mb-1 display-5">{{ $filesPending }}</h2>
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 text-center" style="transition: all 0.2s;">
            ...
            <h2 class="fw-bolder text-dark mb-1 display-5">{{ $totalVerified }}</h2>
    ...
    <div class="col-md-3">
        <div class="card border-0 p-4 h-100 text-center text-white" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); border-radius: 16px; box-shadow: 0 10px 20px rgba(16, 185, 129, 0.2);">
            ...
            <h2 class="fw-bolder mb-1 display-5 text-white">{{ $totalPublished }}</h2>
    ...
    <div class="col-12">
        <div class="card glass-card border-0 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('operator.riwayat') }}" class="btn btn-sm btn-light rounded-pill px-3 fw-medium">Lihat Semua</a>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle border-0">
                    ...
                    <tbody class="border-top-0">
                        @forelse($recentSubmissions as $skripsi)
                        <tr>
                            <td class="ps-3 py-3">
                            ...
                            <td class="py-3">
                                ...
                                @else
                                    <span class="badge bg-secondary px-3 py-2 rounded-pill">{{ ucwords(str_replace('_', ' ', $skripsi->status)) }}</span>
                                @endif
                            </td>
                            <td class="pe-3 py-3 text-muted small fw-medium">{{ $skripsi->updated_at->diffForHumans() }}</td>
                        </tr>
                        @empty
                        <tr>
