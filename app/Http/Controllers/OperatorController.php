...
class OperatorController extends Controller
{
    public function index()
    {
        ...
        $sktlPending = \App\Models\Skripsi::where('jurusan_id', $jurusanId)->where('sktl_status', 'pending')->count();
        $filesPending = \App\Models\Skripsi::where('jurusan_id', $jurusanId)->where('file_status', 'pending')->count();
    ...
    public function indexPublished()
    {
        $skripsis = \App\Models\Skripsi::with(['user', 'jurusan'])
            ...
            ->get();
        return view('operator.publikasi', compact('skripsis'));
    }
    ...
    {
        // Placeholder for statistik
        return view('operator.statistik');
    }}
